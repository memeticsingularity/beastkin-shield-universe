...
### [Volume 1: Bear and Gate / 第一卷：熊与门](./volume-1/)

- **Status / 状态**: Ongoing / 连载中
- **Chapters / 章节数**: 5 chapters released / 5章已发布
- **Synopsis / 简介**:
...
- **Wish Modules / 心愿模组**: A collection of special abilities possessed by the player, including Heart-to-Heart Bond, Magic of Time, Unlimited Home, etc. / 玩家拥有的特殊能力集合，包括心有灵犀的羁绊、时间的魔法、不设限的家等
- **Canon vs Modded Playthrough / 背板剧情 vs 温暖存档**: The inevitable tragedy under the world's default operating rules vs the localized fate rewrite after player intervention / 世界默认运行规则下的必然悲剧 vs 玩家介入后的局部命运改写
- **Follower Contract / 随从契约**: A unique bond system established through sincerity and warmth rather than violent conquest / 通过真诚与温暖而非暴力征服建立的独特羁绊系统
...
- [Chinese Version / 中文版](../../../chinese/chaptered-stories/main/README.md)
...
[Return to Beastshield Paradise Home / 返回兽盾乐园首页](../../../../README.md) | [Return to Project Home / 返回项目主页](../../../../../../README.md)
