...
短篇故事为单篇完结的独立作品，篇幅精炼，聚焦于特定场景、角色互动或情节切片。改编作品需基于《万兽盟》原作世界观进行创作。

---

## I. Format Overview

Short stories are self-contained single-piece works, concise in length, focusing on specific scenes, character interactions, or plot slices. Adaptations must be based on the United Beasts Alliance original world.
