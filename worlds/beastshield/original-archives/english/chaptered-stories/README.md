# Chaptered Story Originals / 分章长篇原作

> Official chaptered story English originals of the BeastShield universe.
> 《兽盾》世界观官方分章长篇英文原作。
...
| Path | Description | 说明 |
|------|-------------|------|
| [`main/`](main/) | Main storyline | 主线故事 |
| [`side/`](side/) | Side stories | 支线故事 |

---

## II. Main Stories / 主线故事

| Code | Title | Tags | Link |
|------|-------|------|------|
| `bs-o-cm-1-main-story-1` | Beastshield Main Story Vol.1: Beast Game World | `main` `VR` `game-mechanics` | [Index](main/bs-o-cm-1-main-story-1/README.md) |
| `bs-o-cm-1-main-story-2` | Beastshield Main Story Vol.2: Moying | `main` `agent-bureau` `moying` | [Index](main/bs-o-cm-1-main-story-2/README.md) |
| `bs-o-cm-1-main-story-3` | Beastshield Main Story Vol.3: White Capital | `main` `final-battle` `twelve-divine-weapons` | [Index](main/bs-o-cm-1-main-story-3/README.md) |

---

## III. Side Stories / 支线故事
