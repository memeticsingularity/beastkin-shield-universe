...
├── readme.md                          # 本文件
├── chinese/                           # 中文正文（已发布章节）
│   ├── ch-1-the-rabbits-shadow.md     # 第一章：白兔暗影
│   ├── ch-2-ore-and-undercurrents.md  # 第二章：矿石与暗流
│   ├── ch-3-tower-of-bloodbath.md     # 第三章：血染之塔
│   ├── ch-4-white-shadow-venomous-fangs.md  # 第四章：白影毒牙
│   └── ch-5-the-collar.md             # 第五章：项圈
└── setting/                           # 设定资料
    ├── characters/                    # 角色设定
    │   ├── qiu-qi.md                  # 仇染
    │   ├── yan-sui.md                 # 岩岁
