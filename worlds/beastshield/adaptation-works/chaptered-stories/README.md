...
| [**冥府牛头**](bs-a-cs-15-hell-bull/README.md) | 从玩家随口一句调侃的外号，到十三层刑房里的不死传说——牛杂走向"冥府牛头"的路。 | `原作回响' `悲剧' `牛杂` |
| [**熊组长**](bs-a-cs-16-bear-captain/README.md) | 那个连打架都发抖的憨厚熊掌，是如何成为十一层炼药房的有尊严守护者的。 | `原作回响' `悲剧' `熊掌` |
...
3. **原作关联 / Original Link**: 改编作品需在 `metadata.yaml` 中标注原作来源。
