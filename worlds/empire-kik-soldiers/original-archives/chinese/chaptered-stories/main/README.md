...
*Long Live the Empire* is a **dark sci-fi military web novel** created by **骸虎**, serving as the
cornerstone work of
...
主线之外，原作者骸虎另撰有三部番外，时间线横跨帝国初期至 vol-7 之后，并引入全新角色线：

| 编号 | 标题 | 时间线 | 核心角色 | 章节数 | 链接 |
|------|------|--------|----------|:--:|:--|
| extra-001 | 后日谈短篇合集 | vol-7后 / 帝国初期 | 虎猛、各路基尅兵 | 9章 | [目录](../extras/extra-001/README.md) |
| extra-002 | 虎猛的进食与巡查 | vol-7后 | 虎猛（实验型少主） | 7章 | [目录](../extras/extra-002/README.md) |
| extra-003 | 帕图斯的精液操控 | 主线平行时间 | 帕图斯（反抗者） | 18章 | [目录](../extras/extra-003/README.md) |
...
- **内容警告**：尽管已进行净化和转向，讨论的基础设定本身仍涉及 **压迫、身体政治、非自愿改造与死亡机制**
  。请读者根据自身承受能力判断是否继续浏览。
