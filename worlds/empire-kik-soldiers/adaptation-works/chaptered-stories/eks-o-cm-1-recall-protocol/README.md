...
> |:--|:--:|:--|
> | 🔞 性内容 / Sexual Content | **Lv.3** | 芯片触发射精自毁机制、护裆保护弱点、性器官敏感化描写、撸杀/射精死亡场景 |
> | 💀 暴力与死亡 / Violence & Death | **Lv.3** | 芯片处决、退役召回测试、老兵-新兵生死对决、帝国清洗/处决、培养舱人体实验 |
> | 🧠 心理黑暗度 / Psychological Darkness | **Lv.4** | 退役即缓刑的存在主义绝望、身份异化（袜子=自我）、芯片控制的深层恐惧、系统对个体的绝对碾压 |
> | ⚡ 特殊触发 / Specific Triggers | — | 芯片控制/植入、射精自毁、退役召回、培养舱诞生、身份编号体系、抑制药物依赖、旧袜子焚烧意象 |
>
> ⚠️ **世界观核心机制说明**：本世界核心机制为"芯片控制"——所有士兵颈椎植入控制芯片，射精即触发自毁；军袜等级制度（白袜/绿袜/黑袜）标识身份与权力；培养舱批量生产士兵；退役仅是另一种形式的缓刑，召回随时可能发生。
>
...
### 🔞 情色与身体 / Erotic & Bodily
`芯片触发射精自毁` `护裆/弱点保护` `军袜 fetish` `性器官敏感化` `抑制药物` `撸杀`

### ⚔️ 死亡与暴力 / Death & Violence
`芯片处决` `退役召回测试` `老兵-新兵生死对决` `帝国清洗` `培养舱人体实验`

### 🏛️ 权力与关系 / Power & Relations
`帝国-士兵` `白袜-绿袜-黑袜等级` `退役兵-新兵` `监督官-被监督者` `召回者-被召回者`

### 🎭 主题与情感 / Themes & Emotions
`退役即缓刑` `身份异化` `存在主义绝望` `系统碾压个体` `自由与奴役`

### 🎨 叙事与风格 / Narrative & Style
`冷峻写实` `心理惊悚` `存在主义` `慢节奏感官描写` `反乌托邦`

### 🗺️ 核心场景 / Key Settings
`雪山边境森林` `小木屋` `雪山基地` `培养舱设施` `退役隐居地`

### 🧩 世界观机制 / World Mechanics
`芯片控制` `射精自毁` `军袜等级制度` `培养舱生产` `退役召回` `抑制药物` `基因改造`
